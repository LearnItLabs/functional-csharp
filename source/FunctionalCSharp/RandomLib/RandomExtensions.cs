...
namespace RandomLib {
	public static class RandomExtensions {
		...
		public static RandomResult<double> AsDouble(this RandomResult<int> result) {
			...
			return new RandomResult<double>(doubleConvert, result.Seed); ;
		}
	}
}
